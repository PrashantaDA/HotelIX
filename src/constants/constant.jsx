...
import { Carousel1, Carousel2, Room1, Room2, Room3, Team1, Team2, Team3, Team4, Team5, Team6, Testimonial1, Testimonial2, Testimonial3, Testimonial4 } from "../assets/index.js";
...
/** Team */
export const team = [
	{ image: Team1, name: "GM Name", designation: "General Manager" },
	{ image: Team2, name: "FOM Name", designation: "Front Office Manager" },
	{ image: Team3, name: "Chef Name", designation: "Head Chef" },
	{ image: Team4, name: "Guest Experience Name", designation: "Guest Experience" },
	{ image: Team5, name: "HK Name", designation: "Housekeeping Lead" },
	{ image: Team6, name: "Engineer Name", designation: "Engineering" },
];
...
export const roomItems = [
	{
		...
		btn1: "Details",
		btn2: "Book",
		amenities: ["Queen Bed", "Courtyard View", "Work Desk", "Rain Shower", "Free Wi-Fi"],
		size: "32 m²",
		occupancy: "2 Adults",
		available: true,
	},
	{
		...
		img: Room2,
		price: 125,
		priceDisplay: "From $125/night",
		name: "Terrace Deluxe",
		star: <FaStar className="text-primary" />,
		desc: "Extra space, a private terrace, and a sitting area—popular with couples and longer visits.",
		btn1: "Details",
		btn2: "Book",
		amenities: ["King Bed", "Private Terrace", "Sitting Area", "Soaking Tub", "Mini Bar"],
		size: "45 m²",
		occupancy: "2 Adults",
		available: true,
	},
	{
		...
		img: Room3,
		price: 155,
		priceDisplay: "From $155/night",
		name: "Skyline Suite",
		star: <FaStar className="text-primary" />,
		desc: "Separate living room, skyline views, and a soaking tub—our go-to for celebrations.",
		btn1: "Details",
		btn2: "Book",
		amenities: ["King Bed", "Living Room", "Skyline View", "Soaking Tub", "Room Service"],
		size: "65 m²",
		occupancy: "3 Adults",
		available: true,
	},
	{
		...
		img: Room2,
		price: 135,
		priceDisplay: "From $135/night",
		name: "Executive Twin",
		star: <FaStar className="text-primary" />,
		desc: "Two full beds, ergonomic chairs, and fast Wi‑Fi—built for colleagues traveling together.",
		btn1: "Details",
		btn2: "Book",
		amenities: ["2 Twin Beds", "Work Desk", "Ergonomic Chair", "Coffee Maker", "Fast Wi-Fi"],
		size: "40 m²",
		occupancy: "2 Adults",
		available: true,
	},
	...
	},
	{
		...
		img: Room3,
		price: 210,
		priceDisplay: "From $210/night",
		name: "Presidential Suite",
		star: <FaStar className="text-primary" />,
		desc: "Top floor, panoramic views, dining for six, and dedicated concierge coordination.",
		btn1: "Details",
		btn2: "Book",
		amenities: ["2 King Beds", "Panoramic View", "Dining Room", "Private Butler", "Jacuzzi"],
		size: "120 m²",
		occupancy: "4 Adults",
		available: true,
	},
...
export const testimonials = [
	{
		...
		rating: 5,
		text: "An absolutely stunning hotel in the heart of Thamel. The staff went above and beyond to make our honeymoon special. The room was immaculate with breathtaking views of the mountains.",
		image: Testimonial1,
		date: "March 2026",
	},
	{
		...
		country: "Singapore",
		rating: 5,
		text: "Perfect location, exceptional service. The terrace breakfast is a must-do experience. I've stayed at many hotels in Kathmandu, and HotelX stands out for its attention to detail.",
		image: Testimonial2,
		date: "February 2026",
	},
	{
		...
		country: "Spain",
		rating: 5,
		text: "From the moment we arrived, we felt like royalty. The spa is world-class, and the team arranged a beautiful surprise dinner on the terrace for our anniversary.",
		image: Testimonial3,
		date: "January 2026",
	},
	{
		...
		country: "Australia",
		rating: 4,
		text: "Excellent value for luxury accommodation. The room was spacious, clean, and beautifully designed. Would definitely recommend to anyone visiting Kathmandu.",
		image: Testimonial4,
		date: "December 2025",
	},
];
