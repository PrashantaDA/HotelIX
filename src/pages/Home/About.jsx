  ...
  return (
    <section className="my-16 xs:w-[90%] md:w-[85%] xl:w-4/5 mx-auto py-10 flex items-start justify-between xs:flex-col lg:flex-row gap-12 lg:gap-x-16">
      <div className="flex-1">
        <p className="relative text-sm uppercase tracking-[0.2em] text-primary font-semibold font-sans inline-block">
          About Us
          <span className="absolute left-full top-1/2 ml-4 w-12 h-0.5 bg-primary -translate-y-1/2 rounded-full" />
        </p>
        <h1 className="font-display text-4xl md:text-5xl mt-4 text-normal">
          Welcome to <span className="text-primary font-semibold">{siteName}</span>
        </h1>
      ...
      <div className="flex-1 xs:place-self-center lg:place-self-auto w-full max-w-xl lg:max-w-none">
        <div className="grid grid-cols-2 gap-3 md:gap-4">
          <img
            src={About1}
            alt="Hotel interior"
            className="w-full max-w-[220px] lg:max-w-[240px] object-cover justify-self-end self-end hover:scale-[1.02] transition-transform duration-500 rounded-2xl shadow-card"
          />
          <img
            src={About2}
            alt="Hotel lounge"
            className="w-full object-cover rounded-2xl shadow-card hover:scale-[1.02] transition-transform duration-500"
          />
          <img
            src={About3}
            alt="Hotel detail"
          ...
          <img
            src={About4}
            alt="Hotel suite"
            className="w-full max-w-[220px] lg:max-w-[240px] object-cover rounded-2xl shadow-card hover:scale-[1.02] transition-transform duration-500"
          />
        </div>
      </div>
    </section>
